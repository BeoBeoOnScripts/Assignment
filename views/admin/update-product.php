...
<body>
    ...
    ?> 
    <form action="../../controllers/update-product-controller.php" method="POST" enctype="multipart/form-data" class="w-[500px] m-auto">
        <input type="text" name="product-id" value="<?php echo $productId?>" hidden>
